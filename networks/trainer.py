...
class Trainer_arpmulticls(L.LightningModule):
    ...
    def training_step(self, batch):
        ...
        for i, logits_group in enumerate(logits_groups):
            loss += self.opt.model.a * F.cross_entropy(logits_group, cls_y)
